...
modal_3_body += "   className: 'btn btn-primary btn-shadow',\n";
...
$("#modal-4").fireModal({
  footerclassName: "bg-whitesmoke",
  body:
    "Add the <code>bg-whitesmoke</code> className to the <code>footerclassName</code> option.",
  buttons: [
    {
      text: "No Action!",
      className: "btn btn-primary btn-shadow",
...
$("#modal-6").fireModal({
  ...
  created: function (modal) {
    modal
      .find(".modal-footer")
      .prepend(
        '<div className="mr-auto"><a href="#">I\'m a hyperlink!</a></div>'
      );
  },
  buttons: [
    {
