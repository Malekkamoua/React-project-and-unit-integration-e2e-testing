...
$(function () {
      ...
      $(".main-sidebar .sidebar-menu > li").each(function () {
        ...
        if (me.find("> .dropdown-menu").length) {
          ...
          me.find("> .dropdown-menu").prepend(
            '<li className="dropdown-title pt-3">' +
              me.find("> a").text() +
              "</li>"
          );
        } else {
  ...
  var toggleLayout = function () {
    var w = $(window),
      ...
      layout_classNamees =
        layout_className.trim().length > 0 ? layout_className.split(" ") : "";
    ...
    if (w.outerWidth() <= 1024) {
      ...
      $("body")
        ...
        .on("click touchend", function (e) {
          if (
            $(e.target).hasclassName("sidebar-show") ||
            $(e.target).hasclassName("search-show")
          ) {
            $("body").removeclassName("sidebar-show");
            $("body").addclassName("sidebar-gone");
      ...
      if (now_layout_className == "layout-3") {
        ...
        main_sidebar
          .find(".container")
          .addclassName("sidebar-wrapper")
          .removeclassName("container");
        main_sidebar
          .find(".navbar-nav")
          .addclassName("sidebar-menu")
          .removeclassName("navbar-nav");
      ...
      if (now_layout_className) $("body").addclassName(now_layout_className);

      let nav_second_classNamees = $(".main-sidebar").attr(
          "data-nav-classNamees"
        ),
        nav_second = $(".main-sidebar");

      if (
        now_layout_className == "layout-3" &&
        nav_second.hasclassName("main-sidebar")
      ) {
        ...
        main_sidebar
          ...
          .removeclassName("sidebar-wrapper");
        main_sidebar
          .find(".sidebar-menu")
          .addclassName("navbar-nav")
          .removeclassName("sidebar-menu");
